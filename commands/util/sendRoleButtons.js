...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.member.roles.cache.has('1005253744025419837')) return interaction.reply({ content: 'You do not have permission to use this command.', ephemeral: true });
